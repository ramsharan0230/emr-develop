...
class DemandVsOrderVsPurchaseExport implements FromView, WithDrawings, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('reports::demand-vs-order-vs-purchase.demand-vs-order-vs-purchase-excel', $data);
    }
}
