...
class DoctorWiseShareReportPatientExport implements FromView, WithDrawings, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('patbillingshare::excell.doctorwise-share-excel', $data);
    }
