...
class DoctorWiseShareReportWithoutReferalExport implements FromView, WithDrawings, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        return view('patbillingshare::excell.doctor-wise-share-without-referral', $data);
    }
}
