...
class ItemParticularwiseExport implements FromView, WithDrawings, ShouldAutoSize
{
    protected $req;
    ...
    public function view(): View
    {
        ...
        return view('reports::itemreport.excel.export-particularwise-excel', $alldata);
    }
