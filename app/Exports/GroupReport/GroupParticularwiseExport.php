...
class GroupParticularwiseExport implements FromView, WithDrawings, ShouldAutoSize
{
    protected $req;
    ...
    public function view(): View
    {
        ...
        return view('reports::groupreport.excel.export-particularwise-excel',$alldata);
    }
