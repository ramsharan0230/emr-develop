...
class Nepali_Calendar extends Controller
{
    ...
    public function get_month_last_date($year = NULL, $month = NULL)
    {
        if ($year === NULL || $month === NULL || substr($year, 0, 2) !== "20")
            return NULL;

        $year_index = (int) substr($year, 2, 4);
        $month_index = (int) $month;
        return $this->_bs[$year_index][$month_index];
    ...
    public function eng_to_nep($yy, $mm, $dd)
    {
        ...
        else
        {
            ...
            $this->_nep_date['full_date']    = $y . '-' . str_pad($m, 2, 0, STR_PAD_LEFT) . '-' . str_pad($total_nDays, 2, 0, STR_PAD_LEFT);
    ...
    public function nep_to_eng($yy, $mm, $dd)
    {
        ...
        else
        {
            ...
            $this->_eng_date['full_date']    = $y . '-' . str_pad($m, 2, 0, STR_PAD_LEFT) . '-' . str_pad($total_eDays, 2, 0, STR_PAD_LEFT);
