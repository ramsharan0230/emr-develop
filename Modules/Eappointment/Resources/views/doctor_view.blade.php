...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <li class="nav-item">
                <a class="nav-link" style="background-color: unset;" aria-current="page" href="{{ route('eappointment-doctor-setup') }}">
                    Add User</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" style="background-color: unset;" aria-current="page"
                href="javascript:void(0)" >Manage User</a>
            </li>
        </ul>
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="iq-card-body">
                        ...
                        <div class="table-sticky-th" style="width: 100%;">
                            <table class="table expandable-table custom-table table-bordered table-striped mt-c-15"
                                id="myTable1" data-show-columns="true" data-search="true" data-search-align="left" data-show-toggle="true"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item bed_exchange"
                                                            href="{{ route('eappointment-doctor-edit', $user->id) }}">
