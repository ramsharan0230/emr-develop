...
<form id="obstetric-request-submit" >
    ...
    <input type="hidden" name="route" class="change_obstetric_action" value="">
    <div class="modal-body">

        <div class="form-group form-row">
            <label for="" class="col-sm-2 col-form-label "> Name</label>
            <div class="col-md-10">
                <input type="text" readonly class="form-control" id="patientname" value="@if(isset($patient) and $patient !=''){{ Options::get('system_patient_rank')  == 1 && (isset($encounter[0])) && (isset($encounter[0]->fldrank) ) ?$encounter[0]->fldrank:''}} {{ $patient->fldptnamefir }}{{ $patient->fldptnamelast }}@endif">
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group form-row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control changepp datepicker" name="lmp_ad" id="lmp_ad" value="@if(isset($lmp) and $lmp !=''){{$lmp->fldreportquali}}@endif">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group form-row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control changepp " name="edd_ad" id="edd_ad" value="@if(isset($edd) and $edd !=''){{$edd->fldreportquali}}@endif">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function updateFinalObstetric(){
        ...
        // data :   $("form").serialize();
        // console.log(data);
        var url = "{{ route('discharge.final.obstetric.form.save.waiting') }}";
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#diagnosistext').empty().append(response);
