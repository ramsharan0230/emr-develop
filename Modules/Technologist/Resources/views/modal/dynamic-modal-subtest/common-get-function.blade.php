...
<script>
    ...
    $.get('{{ route("techno.option.test.get.qualitative") }}?test_name=' + test_name + '&input_mode=' + input_mode, function (data) {
...
function getDistinctGroup(test_name, input_mode) {
    ...
    $.get('{{ route("techno.distinct.test.get.group.qualitative") }}?test_name=' + test_name + '&input_mode=' + input_mode, function (data) {
        $.each(data, function (index, getRelatedData) {
...
function getClinicianScale(test_name, input_mode) {
    ...
    $.get('{{ route("techno.option.test.clinical.qualitative") }}?test_name=' + test_name + '&input_mode=' + input_mode, function (data) {
        var num = 1;
        $.each(data, function (index, getRelatedData) {
