...
@endpush
<div class="tab-pane fade show active" id="otchecklist" role="tabpanel" aria-labelledby="otchecklist-tab">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="customCheck5"><b>Confirm all team members have introduced themselves by name and role.</b>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
