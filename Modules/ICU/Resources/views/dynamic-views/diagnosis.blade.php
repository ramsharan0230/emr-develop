<div class="modal fade" id="dliago_group" tabindex="-1" role="dialog" aria-labelledby="allergicdrugsLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form method="post" id="pro-diagnosis">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="updateProDiagnosis()">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    function updateProDiagnosis(){
        // alert('diagn')
        var url = "{{route('diagnosisStoreInpatient')}}";
