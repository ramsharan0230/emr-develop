    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            @if($type == 'Left and Right')
                <button type="button" id="js-deliveryexamination-examination-save-modal" class="btn save-btn btn-sm"><img src="{{ asset('assets/images/tick.png') }}" alt="" width="15px;">
                    &nbsp;&nbsp;Save
                </button>
            @elseif($type == 'No Selection')
                <div></div>
            @else
                <input type="submit" name="submit" id="js-deliveryexamination-examination-save-modal" class="btn btn-primary" value="Save">
            @endif
        </div>
    </div>
</div>
