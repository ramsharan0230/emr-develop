<head>
    <title>Top 10 Performing Departments</title>
                ...
                <tr>
                    ...
                    <td style="width:80%;">
                        ...
                        <h4 style="text-align: center;margin-top:4px;">{{ isset(Options::get('siteconfig')['system_address'])?Options::get('siteconfig')['system_address']:'' }}</h4>
                            <h4 style="text-align: center;">Top 10 Performing Departments({{$encountertype}})</h4>
                    </td>
    ...
    <div class="table-responsive res-table" style="max-height: none">
        <table class="table content-body">
            ...
            <tr>
                ...
                <th style="text-align: left;">Numbers of Consultation</th>
            </tr>
            </thead>
            <tbody>
