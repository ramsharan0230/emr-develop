                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('toptendoctor')}}" type="button" class="btn btn-light btn-action" ><i class="fa fa-redo"></i>&nbsp;Reset</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    function pdfTopTenDeptReport() {
        ...
        var urlReport = baseUrl + "/department/topTenDoc/report?" + data + "&action=" + "Report" + "&_token=" + "{{ csrf_token() }}"+"&page="+page;
    ...
    function exportTopLabTestReport() {
        ...
        var data = $("#top_lab_test").serialize();
        var urlReport = baseUrl + "/department/topTenDoc/export?" + data + "&action=" + "Report" + "&_token=" + "{{ csrf_token() }}"+"&page="+page;
        window.open(urlReport, '_blank');
    }
