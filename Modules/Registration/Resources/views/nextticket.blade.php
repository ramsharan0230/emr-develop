...
<table class='header_table' style="text-align: left; width: 100%; font-size:8pt; margin-bottom: 0;" id="headtable">
    <tr>
        ...
        <td>
            ...
            <p>
                Add.: {{  ($patient && $patient->patientInfo) ? "{$patient->patientInfo->fldmunicipality}-{$patient->patientInfo->fldwardno}, {$patient->patientInfo->fldptadddist},{$patient->patientInfo->fldptaddvill}, {$patient->patientInfo->fldprovince}" : '' }}
            </p>
