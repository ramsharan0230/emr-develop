                ...
                <div class="iq-card-body">
                    ...
                    <form action="{{ route('sidebar.menu.store') }}" method="POST" id="create-sidebarmenu-form" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <option value="{{ $module->module }}" @if($sidebarmenu->permission_module == $module->module) selected @endif>{{ $module->module }} </option>
                            @empty
                            @endforelse
                        </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="mainmenu" id="mainmenu-name" class="form-control mainmenu">
                                    ...
                                    <option value="{{ $mainmenu->mainmenu }}" @if($sidebarmenu->mainmenu == $mainmenu->mainmenu) selected @endif>{{ $mainmenu->mainmenu }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="submenu" name="submenu" class="form-control" value="{{$sidebarmenu->submenu}}" placeholder="Enter Sub Menu">
                            </div>
                        </div>
                        <input type="hidden" id="menu_id" name="menu_id" class="form-control" value="{{$sidebarmenu->id}}" >

                        <div class="form-group row">
                            <label class="control-label col-sm-2 align-self-center mb-0" for="">Route:</label>
                            <div class="col-sm-4">
                                <input type="text" id="routelink" name="routelink" class="form-control" value="{{$sidebarmenu->route}}" placeholder="Enter Route">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-2 align-self-center mb-0" for="">Icon:</label>
                            <div class="col-sm-4">
                                <input type="text" id="icon" name="icon" class="form-control" value="{{$sidebarmenu->icon}}" placeholder="Enter Icon">
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="order_by" name="order_by" class="form-control" value="{{ old('order_by') }}" placeholder="Enter Order Number" value="1">
                            </div>
                        </div> -->
...
<script>
    $(document).ready(function() {
        ...
        $(document).on("click", "#submitmenu", function(e) {
            menu = $('#menu_id').val();
            var url = baseUrl+"/setting/sidebar/update/"+menu;
            $.ajax({
                url: url,
                type: "POST",
                data: {
