        ...
        <div class="col-sm-12">
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                <div class="iq-card-header d-flex justify-content-between align-items-center">
                  ...
                  <a href="{{ route('hospital.branch.add') }}" class="btn btn-primary"><i
...
@push('after-script')
    ...
    var branch = {
        editBranch:function (id) {
            window.location.href = baseUrl+"/setting/hospital-branch/edit/"+id;
        },
        deleteBranch:function (id) {
                ...
                $.ajax({
                    url: '{{ route('hospital.branch.delete') }}',
                    type: "POST",
                    data: {id:id},
                    success: function (response) {
                        if (response.success.status) {
                            $("#branch-table").empty().append(response.success.html);
