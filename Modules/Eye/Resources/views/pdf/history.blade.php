    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="width: 200px;">
                <p>Name:  {{ Options::get('system_patient_rank')  == 1 ? $patientinfo->fldrank : '' }} {{ $patientinfo->fldptnamefir . ' ' . $patientinfo->fldmidname . ' ' . $patientinfo->fldptnamelast }} ({{$patientinfo->fldpatientval}})</p>
