    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            @if($type == 'Left and Right')
                <label class="leftright-label">
                    <input type="checkbox" id="js-abnormal" class="pull-left">&nbsp;&nbsp;Abnormal
                </label>
                <button type="button" id="js-examination-add" class="btn save-btn btn-sm"><img src="{{ asset('assets/images/tick.png') }}" alt="" width="15px;">
                    &nbsp;&nbsp;Save
                </button>
            @elseif($type == 'No Selection')
                <div></div>
            @else
                <input type="submit" name="submit" id="js-examination-add" class="btn btn-primary" value="Save changes">
            @endif
        </div>
    </div>
</div>
