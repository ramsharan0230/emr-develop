    ...
    <div class="modal-content">
            ...
            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="title-input">
                                        <select class="js-modal-select form-control">
                ...
                @elseif($type == 'No Selection')
                    ...
                    <div class="checkbox-container" style="margin-top: 0px;">
                        <div class="checkbox">
                            <button type="button" id="js-triage-examination-add" class="btn btn-success btn-sm">Save</button>
        ...
        <div class="modal-footer">
            @if($type == 'Left and Right')
                <button type="button" id="js-triage-examination-add" class="btn save-btn btn-sm"><img src="{{ asset('assets/images/tick.png') }}" alt="" width="15px;">
                    &nbsp;&nbsp;Save
                </button>
            @elseif($type == 'No Selection')
                <div></div>
            @else
                <input type="submit" name="submit" id="js-triage-examination-add" class="btn btn-primary" value="Save changes">
            @endif
        </div>
    </div>
</div>
