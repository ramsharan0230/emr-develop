            ...
            <div class="modal-footer">
                <div class="form-group form-row">
                    ...
                    <div class="col-md-2">
                        ...
                        <button type="button" class="btn btn-primary update_btn" id="js-obstetric-diagnosis-update-btn" onclick="updateProObstetric()">Update</button>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function updateProObstetric(){
        alert('pro here');
         // data :   $("form").serialize();
         // console.log(data);
                var url = "{{ route('inpatient.obstetric.form.save.waiting') }}";
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#provisional_delete').empty().append(response);
