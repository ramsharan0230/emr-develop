    ...
    <div class="row">
        ...
        {{--<div class="col-md-2">
            <!-- <div class="form-group-phar">
                <input type="checkbox" name="display_keypad" id="display_keypad">
                <label for="display_keypad" class="col-form-label">Display Keypad</label>
            </div> -->
            <div class="form-row">
                <div class="col-6">
                    <div class="custom-control custom-radio">
                        <input type="radio" id="pharmacy_value" name="pharmacy_value_lable" class="custom-control-input">
                        <label class="custom-control-label" for="pharmacy_value"> Value</label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="custom-control custom-radio">
                        <input type="radio" id="pharmacy_lable" name="pharmacy_value_lable" class="custom-control-input">
                        <label class="custom-control-label" for="pharmacy_lable">Label</label>
                    </div>
                </div>
            </div>
        </div>--}}
    ...
    var pharmacyPopup = {
        ...
        clickMedSelect: function () {
            ...
            if (drugType == 'msurg' || drugType == 'ortho') {
                ...
                $('#pharnmacy_dose').prop('disabled', true);
                $('#pharnmacy_freq').prop('disabled', true);
                $('#pharnmacy_day').prop('disabled', true);
                $('#pharnmacy_qty').val(0);
        ...
        $('form').submit(false);
           ...
           var url= "{{ route('populate-patient-profile') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data.medicationhtml)
                   if(data.length != 0)
                   {
