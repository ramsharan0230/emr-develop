<form action="{{ route('patient.services.form.save.waiting') }}" class="services-form" id="services-request-submit" method="post">
    @csrf
    @php
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-8">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="javascript:void(0)" class="btn btn-primary btn-action disableInsertUpdate" onclick="insertUpdateRequestServices.updateRequest();"><i class="fas fa-save"></i>&nbsp;Save</a>

                                        <a href="javascript:void(0)" class="btn btn-outline-primary btn-action  disableInsertUpdate" onclick="insertUpdateRequestServices.cancelRequest()"><i class="fas fa-times"></i>&nbsp;Cancel</a>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    var insertUpdateRequestServices = {
        ...
        deleteRequestedData: function (fldid) {
            ...
            $.ajax({
                url: "{{ route('patient.services.delete.services.requested') }}",
                type: "POST",
