        ...
        <div class="modal-content">
            <form method="post" action="{{ route('text_save') }}">
                ...
                <div class="modal-header">
                    <!-- <h5 class="modal-title" id="single_selection_boxLabel" style="text-align: center;">Edit Complaint</h5> -->
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="submit" id="submitnumber_box" class="btn btn-primary" value="Save changes">
                </div>
            </form>
        </div>
    </div>
