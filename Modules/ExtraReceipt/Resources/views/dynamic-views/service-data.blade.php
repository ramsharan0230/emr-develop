<input type="text" class="form-control" id="searchService" onkeyup="searchServiceItems()" placeholder="Search for names..">
    ...
    <table class="table table-striped" id="searchServiceTable">
        ...
        @if($services)
            @forelse($services as $service)
                <tr>
                    <td>
                        <input type="checkbox" name="serviceItem[]" value="{{ $service->fldid }}">
                    </td>
