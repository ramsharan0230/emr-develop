                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Dynamic Report Setup</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <form id="dynamicform" action="{{route('store.dynamic.report')}}" method="POST" class="form-horizontal">
                                    @csrf
                                    <div class="form-group form-row align-items-center">
                                        <label for="" class="col-sm-3">Report Name*</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="reportname" id="reportname" class="form-control" placeholder="Enter Report Name" required>
                                        </div>
                                    </div>
                                    <div class="form-group form-row align-items-center">
                                        <label for="" class="col-sm-3">Slug*</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="reportslug" id="reportslug" class="form-control" readonly required>
                                        </div>
                                    </div>
                                    <div class="form-group form-row align-items-center">
                                    ...
                                    <div class="form-group form-row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="fldquery" id="query" class="form-control" rows="8" required></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                    ...
                                    <div class="form-group form-row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <button type="submit" id="saveForm" class="btn btn-primary btn-action">Save</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        ...
        $(document).on('blur','#query',function(){
            ...
            if(!query.includes('SELECT') && !query.includes('select')){
                showAlert("Query must be select query!!!",'error');
                return false;
            }
