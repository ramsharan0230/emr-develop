                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Dynamic Reports</h4>
                        </div>
                    </div>
                    <div class="iq-card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-3">
                                <div class="form-group form-row">
                                    <label for="" class="col-sm-3">Reports:</label>
                                    <div class="col-sm-9">
                                        <select name="reportslug" id="reportslug" class="form-control">
                                            @foreach ($reports as $report)
                                                <option value="{{$report->fldreportslug}}">{{$report->fldreportname}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
