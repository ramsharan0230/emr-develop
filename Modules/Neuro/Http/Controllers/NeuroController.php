...
//    private function create($encounterNo)
//    {
//
//        if ($encounterNo) {
//
//            $encounter = Encounter::where('fldencounterval', $encounterNo)->first();
//
//            if ($encounter) {
//
...
//
//                    $data['encounterNo'] = $encounterNo;
//
////                    $data['userDetail'] = Auth::guard('admin')->user();
//
//                    $data['Notes'] = Notes::whereDate('fldtime', Carbon::today())
//                        ->where('fldencounterval', $encounter->fldencounterval)
//                        ->where('fldinput','Notes')
//                        ->get(); // confusion
//                    $data['patient_diagnosis'] = PatientFinding::where('fldencounterval', $encounter->fldencounterval)
//
//                        ->where('fldtype', 'Provisional Diagnosis')->get();
//
//                    $data['drugs_list'] = PatDosing::with('nursedosing')->where(
...
//        PatientProfileExtra::insert($patient_profile_extra);
            ...
            $chestAndEye = [
                ...
                'arms_limb_movement' => $request->get('arms_limb_movement'),

                'limb_limb_movement' => $request->get('limb_limb_movement'),
