@extends('frontend.layouts.master') @section('content')
    ...
    @else
        ...
        @endphp
    @endif
    @include('menu::common.neuro-nav-bar')
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Limb Movement</h4>
                            </div>
                        </div>
                        <div class="iq-card-body">
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 5%;">
                                        <label for="arms_limb_movement" class="lable-gcs">Arms</label>
                                    </td>
                                    <td>
                                        <select name="arms_limb_movement" id="arms_limb_movement"
                                                class="form-control">
                                            <option value="">--Select--</option>
                                            <option value="normal_power">Normal Power</option>
                                            <option value="mild_weakness">Mild Weakness</option>
                                            <option value="severe_weakness">Severe Weakness</option>
                                            <option value="spastic_flexion">Spastic Flexion</option>
                                            <option value="extension">Extension</option>
                                            <option value="no_response">No Response</option>
                                        </select>
                                    </td>
                                    <td style="width: 7%;" class="text-right">
                                        <label for="limb_limb_movement" class="lable-lines">Limb:</label>
                                    </td>
                                    <td>
                                        <select name="limb_limb_movement" id="limb_limb_movement"
                                                class="form-control">
                                            <option value="">--Select--</option>
                                            <option value="normal_power">Normal Power</option>
                                            <option value="mild_weakness">Mild Weakness</option>
                                ...
                                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{$encounter_no?route('icu.generate.report',$encounter_no):''  }}"
