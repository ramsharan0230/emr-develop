...
<div class="container-fluid">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-8 col-md-12">
                        <div class="row">
                            <div class="form-group">
                                <div class="form-inner">
                                    ...
                                    <input type="text" name="fldtestid" value="{{ old('fldtestid') }}" class="form-input-big" placeholder="" style="width: 72%;" required>
                                    {{--                                    <a href=""><img src="{{asset('assets/images/edit.png')}}"></a>--}}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    ...
                                    @endphp
                                    <select name="fldcategory" class="form-select-dietary select2categoryname" required style="width: 72%">
                                        <option value=""></option>
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    ...
                                    @endphp
                                    <select name="fldsysconst" class="form-select-dietary select2sysconstant" style="width: 72%">
                                        <option value=""></option>
                                        <option value="Calcium_Total_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Calcium_Total_Serum') ? 'selected' : ''}}>Calcium_Total_Serum</option>
                                        <option value="Chloride_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Chloride_Serum') ? 'selected' : ''}}>Chloride_Serum</option>
                                        <option value="Creatinine_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Creatinine_Serum') ? 'selected' : ''}}>Creatinine_Serum</option>
                                        <option value="Glucose_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Glucose_Serum') ? 'selected' : ''}}>Glucose_Serum</option>
                                        <option value="Hemoglobin_Blood" {{ (old('fldsysconst') && old('fldsysconst') == 'Hemoglobin_Blood') ? 'selected' : ''}}>Hemoglobin_Blood</option>
                                        <option value="Potassium_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Potassium_Serum') ? 'selected' : ''}}>Potassium_Serum</option>
                                        <option value="Sodium_Serum" {{ (old('fldsysconst') && old('fldsysconst') == 'Sodium_Serum') ? 'selected' : ''}}>Sodium_Serum</option>
                                        <option value="Urea_Nitrogen_Blood" {{ (old('fldsysconst') && old('fldsysconst') == 'Urea_Nitrogen_Blood') ? 'selected' : ''}}>Urea_Nitrogen_Blood</option>
                                        <option value="pH_Blood" {{ (old('fldsysconst') && old('fldsysconst') == 'pH_Blood') ? 'selected' : ''}}>pH_Blood</option>
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    ...
                                    @endphp
                                    <select name="fldspecimen" class="form-select-dietary select2specimen" required style="width: 72%">
                                        <option value=""></option>
                                        @forelse($sampletypes as $sampletype)
                                            <option value="{{ $sampletype->fldsampletype }}" data-id="{{ $sampletype->fldid }}" {{ (old('fldspecimen') && old('fldspecimen') == $sampletype->fldsampletype) ? 'selected' : ''}}>{{ $sampletype->fldsampletype }}</option>
                                        @empty
                                        @endforelse
                                    </select>&nbsp;
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    ...
                                    <input type="text" name="fldcollection" value="{{ old('fldcollection') }}" class="form-input-big" placeholder="" style="width: 72%">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 padding-none">
                                    <div class="form-inner">
                                        ...
                                        <input type="number" step="any" name="fldsensitivity" value="{{ old('fldsensitivity') }}" class="form-input-small" placeholder="0">
                                    </div>
                                </div>
                                <div class="col-md-6" style="padding-left: 124px;">
                                    <div class="form-inner">
                                        <label for="" class="form-label">Specificity</label>
                                        <input type="number" step="any" name="fldspecificity" value="{{ old('fldspecificity') }}" class="form-input-small" placeholder="0">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 padding-none">
                                    <div class="form-inner">
                                        ...
                                        <input type="number" step="any" name="fldcritical" value="{{ old('fldcritical') }}" class="form-input-small" placeholder="">
                                    </div>
                                </div>
                                <div class="col-md-6" style="padding-left: 124px;">
                                    <div class="form-inner">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    <textarea name="flddetail" class="form-text">{!! old('flddetail') !!}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="form-inner">
                                    <textarea name="fldcomment" class="form-text">{!! old('fldcomment') !!}</textarea>
                                </div>
                            </div>

                        </div>
                        <div class="col-md-2 padding-none" style="float: right;">
                            <button class="default-btn f-btn-icon-b"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cogent-nav">
        ...
        <div class="container-fluid">
            <form action="{{ route('diagnostictest.add') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
