                                    ...
                                    <table class="full-width">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="p-1"> <input type="number" class="form-control" id="quantitative_lower_mu" value="0"></td>
                                                <td class="p-1"><input type="number" class="form-control" id="quantitative_lower_si" value="0"></td>
                                            </tr>
                                             <tr>
                                                <td class="p-1">Upper Limit</td>
                                                <td class="p-1"><input type="number" class="form-control" id="quantitative_upper_mu" value="0"></td>
                                                <td class="p-1"> <input type="number" class="form-control" id="quantitative_upper_si" value="0"></td>
                                            </tr>
                                             <tr>
                                                <td class="p-1">Normal Value</td>
                                                <td class="p-1"><input type="number" class="form-control" id="quantitative_normal_mu" value="0"></td>
                                                <td class="p-1"><input type="number" class="form-control" id="quantitative_normal_si" value="0"></td>
                                            </tr>
                                             <tr>
