                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-row">
                                ...
                                <div class="col-2">
                                    <button type="button" class="btn btn-primary insert-test-option" url="{{ route('examination.insert.test.option') }}"><i class="fas fa-edit"></i> Update</button>
                                </div>&nbsp;
                                <div class="col-2">
                                    <button type="button" class="btn btn-danger insert-test-option" url="{{ route('examination.insert.test.option') }}"><i class="fas fa-trash"></i> Delete</button>
                                </div>&nbsp;
                            </div>
                        </div>
                    </div>
