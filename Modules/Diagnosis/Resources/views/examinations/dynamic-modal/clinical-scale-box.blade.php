                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-row">
                                ...
                                <div class="col-2">
                                    <button type="button" class="btn btn-primary insert-clinical-scale" url="{{ route('examination.insert.clinical.scale') }}"><i class="fas fa-plus"></i> Add</button>
                                </div>&nbsp;
                                <div class="col-2">
                                    <button type="button" class="btn btn-danger delete-clinical-scale" url="{{ route('examination.delete.clinical.scale') }}"><i class="fas fa-trash"></i> Delete</button>
                                </div>&nbsp;
                            </div>
                        </div>
                    </div>
