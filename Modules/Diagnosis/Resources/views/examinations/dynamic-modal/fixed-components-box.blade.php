                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-row">
                                ...
                                <div class="col-4">
                                    <label><input type="text" class="form-control" class="sub-test-name"/> </label>
                                </div>
                            </div>
                            <div class="form-group form-row">
                                <div class="col-3">
                        ...
                        <div class="col-md-12">
                            <div class="group__box half_box">
                                <div class="box__btn__clinical">
                                    <button type="button" class="btn btn-primary insert-test-option-fixed" url="{{ route('examination.insert.first.level.test.option') }}"><i class="fas fa-plus"></i> Add</button>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-row">
                                <div class="col-3"></div>
                                <div class="col-2">
                                    <button type="button" class="btn btn-primary fixed-sub-common-type-insert " url="{{ route('examination.fixed.sub.common.type.insert') }}"><i class="fas fa-plus"></i>&nbsp;Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="group__box half_box">
                                <div class="box__btn__clinical">
                                    <button type="button" class="btn btn-primary fixed-sub-clinical-type-insert" url="{{ route('examination.fixed.sub.common.type.insert') }}"><i class="fas fa-plus"></i>&nbsp;Add</button>
                                </div>&nbsp;
...
<script>
    $(document).ready(function () {
        $("#fixed-components-box").on('show.bs.modal', function () {
    ...
    function getMainTestOption(test_name) {
        ...
        $.get('{{ route("examination.exam.quali.old.data") }}?fldexamid=' + test_name, function (data) {

            $.each(data.data, function (index, getRelatedData) {
                // console.log(getRelatedData)
                $('.display-test-option-list').append('<tr class="remove-me-' + getRelatedData.fldid + '" rel="' + getRelatedData.fldid + '" rel2="' + getRelatedData.fldsubtest + '"><td>' + getRelatedData.fldsubtest + '</td><td><a href="javascript:;" onclick="deleteFirstTestOption(' + getRelatedData.fldid + ')"><img src="{{ asset('assets/images/cancel.png') }}" width="16px"></a></td></tr>');
    ...
    function getMainSubTestOption(test_name, subtest_name) {
        ...
        $.get('{{ route("examination.sub.test.quali.old.data") }}?fldexamid=' + test_name + '&fldsubtest=' + subtest_name, function (data) {
            $.each(data.data, function (index, getRelatedData) {
                $('.display-test-option-list-sub').append('<tr class="remove-me-' + getRelatedData.fldid + '" rel="' + getRelatedData.fldid + '" rel2="' + getRelatedData.fldanswer + '"><td>' + getRelatedData.fldanswer + '</td><td><a href="javascript:;" onclick="deleteSubTestQuali(' + getRelatedData.fldid + ')"><img src="{{ asset('assets/images/cancel.png') }}" width="16px"></a></td></tr>');
        ...
        $.ajax({
            ...
            success: function (data) {
                if ($.isEmptyObject(data.status)) {
                    ...
                    $('.display-test-option-list').append('<tr class="remove-me-' + data.fldid + '" rel="' + data.fldid + '" rel2="' + data.fldanswer + '"><td>' + data.fldanswer + '</td><td><a href="javascript:;" onclick="deleteFirstTestOption(' + data.fldid + ')"><img src="{{ asset('assets/images/cancel.png') }}" width="16px"></a></td></tr>');
    ...
    $('.fixed-sub-common-type-insert').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if ($.isEmptyObject(data.status)) {
                    showAlert(data.message);
                    $('.display-test-option-list-sub').append('<tr class="remove-me-' + data.fldid + '" rel="' + data.fldid + '" rel2="' + data.fldanswer + '"><td>' + data.fldanswer + '</td><td><a href="javascript:;" onclick="deleteSubTestQuali(' + data.fldid + ')"><img src="{{ asset('assets/images/cancel.png') }}" width="16px"></a></td></tr>');
                    // $('.display-text-addition').attr('old_text_addition', data.fldanswer);
                } else {
                    showAlert(data.message);
                }
    ...
    $('.fixed-sub-clinical-type-insert').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                if ($.isEmptyObject(data.status)) {
                    showAlert(data.message);
                    $('#display-clinical-scale-list').append('<tr class="remove-me-' + data.fldid + '" rel="' + data.fldid + '" rel2="' + data.fldanswer + '"><td>' + data.fldanswer + '</td><td><a href="javascript:;" onclick="deleteSubTestQuali(' + data.fldid + ')"><img src="{{ asset('assets/images/cancel.png') }}" width="16px"></a></td></tr>');
                    // $('.display-text-addition').attr('old_text_addition', data.fldanswer);
                } else {
                    showAlert(data.message);
                }
    ...
    function deleteFirstTestOption(fldid) {
        ...
        $.ajax({
            url: "{{ route('examination.delete.exam.quali') }}",
            type: "POST",
            dataType: "json",
            data: {fldid: fldid},
            success: function (data) {
    ...
    function deleteSubTestQuali(fldid) {
        ...
        $.ajax({
            url: "{{ route('examination.delete.sub.exam.quali') }}",
            type: "POST",
            dataType: "json",
            data: {fldid: fldid},
            success: function (data) {
