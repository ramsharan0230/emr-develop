...
<main>
    ...
    <ul>
        ...
        <li>Date: {{$fromdate}} {{ isset($fromdate) ? "(". \App\Utils\Helpers::dateEngToNepdash($fromdate)->full_date .")" : ''}} TO
            {{$todate}} {{ isset($todate) ? "(" .\App\Utils\Helpers::dateEngToNepdash($todate)->full_date . ")":'' }}
        </li>
    </ul>
