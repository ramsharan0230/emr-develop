                ...
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                            <h4 class="card-title">Cashier Remark Report</h4>
            ...
            <div class="col-sm-12 col-lg-12 ">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-body">
                        <form id="cashier-remarks-report">
                            <div class="row">
                                <div class="col-sm-3">
            ...
            <div class="col-sm-12 col-lg-12 ">
                <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                    <div class="iq-card-body">
                        ...
                        {!! $remarks->appends(request()->input())->render() !!}
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#js-sampling-encounter-export-btn').click(function() {
                var url = baseUrl + '/cashier-remarks-pdf?' + $('#cashier-remarks-report').serialize();
