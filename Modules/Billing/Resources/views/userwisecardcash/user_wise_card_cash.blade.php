                    ...
                    <div class="iq-card-body">
                        <form id="billing_filter_data">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="d-flex">
                                        <a href="javascript:void(0);" type="button" class="btn btn-primary btn-action" onclick="searchCollectionBillingDetail()"><i class="fa fa-check"></i>&nbsp;
                                            Refresh</a>&nbsp;
                                        <a href="javascript:void(0);" type="button" class="btn btn-primary btn-action" onclick="exportUserBillingReport()"><i class="fa fa-code"></i>&nbsp;
                                            Export</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-bordered bilingresult">
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="13" style="text-align: center;">OP Collection</th>
                                            <th colspan="13" style="text-align: center;">IP Collection</th>
                                        ...
                                        <tr>
                                            ...
                                            <th>Card Bill(+)</th>
                                            <th>Card Refund(-)</th>
                                            <th>Net Card Cash Total</th>

                                            <th>Fonepay Bill(+)</th>
                                            <th>Fonepay Refund(-)</th>
                                            <th>Net fonepay Cash Total</th>
                                            <th>Net Total</th>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        function searchCollectionBillingDetail(page) {
            var url = "{{route('search.user.wise.card.cash')}}";
        ...
        function exportUserBillingReport() {
            ...
            // alert(data);
            var urlReport = baseUrl + "/billing/service/export-user-wise-card-cash-report?" + data + "&action=" + "Report" + "&_token=" + "{{ csrf_token() }}";
