...
<head>
    ...
    <style>
        ...
        .invoiceDetail .pdf-container {
            margin: 0 auto;
            width: 95%;
        }

        .invoiceDetail .content-body {
            border-collapse: collapse;
        }

        .invoiceDetail .content-body table {
            page-break-inside: auto
        }

        .invoiceDetail .content-body tr {
            page-break-inside: avoid;
            page-break-after: auto
        }

        .invoiceDetail .content-body td:nth-child(1),
        .invoiceDetail .content-body th:nth-child(1),
        .invoiceDetail .content-body td:nth-child(2),
        .invoiceDetail .content-body th:nth-child(2) {
            text-align: left;

        }


        .invoiceDetail .content-body td,
        .invoiceDetail .content-body th {
        ...
        .invoiceDetail ul li span:first-child {
            text-align: left;
        }

        .invoiceDetail ul li span:nth-child(2) {
            text-align: right;
            width: 150px;
...
{{--                                <td>{{\App\Utils\Helpers::numberFormat($bill_detail->fldtaxamt)}}</td>--}}
    ...
    <table class="table">
            ...
            <tr>
                ...
                <td rowspan="3">
                    <ul>
                        ...
                        <li><span>Previous Deposit:</span><span>Rs. {{ $patbillingDetails ? \App\Utils\Helpers::numberFormat($patbillingDetails->fldprevdeposit) : '0.00' }}</span></li>

                        <li><span>Recv Amt: </span><span>Rs. {{ $patbillingDetails ? \App\Utils\Helpers::numberFormat($patbillingDetails->fldreceivedamt) : '0.00' }}</span></li>
                        <li><span>To be Paid:</span><span>Rs. {{ (($patbillingDetails) and $patbillingDetails->fldcurdeposit < 0) ? \App\Utils\Helpers::numberFormat(abs($patbillingDetails->fldcurdeposit)) : '0.00' }}</span></li>
                    </ul>
                </td>
            </tr>
        @endif
        ...
        <tr>
            <td><p>USER:{{ Auth::guard('admin_frontend')->user()->firstname }} {{ Auth::guard('admin_frontend')->user()->lastname }}({{ Auth::guard('admin_frontend')->user()->flduserid }})
