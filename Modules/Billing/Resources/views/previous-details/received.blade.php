...
<head>
    ...
    <title>Previous received data</title>
</head>
<style>
    @page {
        margin: 24mm 0 11mm;
...
<div class="pdf-container" style="margin: 0 auto; width: 95%;">
    <h5 class="bill-title">Previous Received</h5>
