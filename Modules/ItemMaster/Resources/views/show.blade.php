    ...
    <div class="preview-modal-content">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td class="desc">{{ $items->first()->fldcode }}</td>
            </tr>
        </table>
        <hr>
            ...
            <tr>
                ...
                <td style="width: 50%">
                    <table style="width: 100%">
                        <tr>
                            <td colspan="2">
                                <h6>Fraction Share</h6>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 30%">Other Share:</td>
                            <td>{{ $items->first()->other_share }}%</td>
                        </tr>
                        <tr>
                            <td style="width: 30%">Hospital Share:</td>
                            <td>{{ $items->first()->hospital_share }}%</td>
                        </tr>
                    </table>
                </td>
