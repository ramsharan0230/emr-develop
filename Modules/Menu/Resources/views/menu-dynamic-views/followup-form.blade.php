            ...
            <div class="row">
               <div class="col-md-5">
                  ...
                  <div class="form-group form-row align-items-center">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="followup_date" value="@if(isset($date)){{ $date }}@endif" id="followup_date">
                      </div>
                  </div>
              </div>
              <div class="col-md-2">
    ...
    <script type="text/javascript">
        $(function () {
          ...
          $('#datetimepicker12').val(cdate);
            ...
            //     sideBySide: true
            // });
             $('#datetimepicker12').nepaliDatePicker({
                npdMonth: true,
                npdYear: true,
                yearRange: "-73:-0"
        ...
        function showTestDate(){
          var value = window.document.getElementById("datetimepicker12").value;
          // alert(value);
          var days = $('#days').val();
          if(days.length > 0){
         ...
         var newdatetime = $("#followup_date").val();
          if(datetime){
                $.ajax({
                    ...
                    type: "POST",
                    data: {encounterId: $('#encounter_id').val(),date: datetime},
