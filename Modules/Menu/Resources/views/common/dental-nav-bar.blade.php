                ...
                <ul class="navbar-nav navbar-list">
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                <li>
                                    <a class="iq-sub-card" href="{{ route('dental.reset.encounter') }}">Blank form</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="fileMenu.waitingModalDisplay()">Waiting</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="fileMenu.searchModalDisplay()">Search</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="fileMenu.LastEncounter()">Last EncID</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                ...
                                <!--  <li><a class="iq-sub-card" href="#">MedProduct</a></li> -->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                ...
                                <!--  <li><a class="iq-sub-card" href="javascript:void(0);">Neurology</a></li> -->
                                ...
                                $encID = \Session::get('dental_encounter_id');
                                ...
                                @endphp
                                <!-- <a class="iq-sub-card" href="javascript:;" id="menu-dicom-image">Dicom images</a></li> -->
                                ...
                                @endif
                                <!--   <a class="iq-sub-card" href="javascript:void(0);">Screen Drawing</a></li> -->
                                ...
                                <li class="inner-submenu">
                                    ...
                                    <div class="iq-inner-sub-dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ Session::has('dental_encounter_id')?route('patient.dataview.pdf.complete', [Session::get('dental_encounter_id'),'opd']??0 ): '' }}" target="_blank" class="iq-sub-card">Complete</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('dental_encounter_id')?route('patient.dataview.pdf.examination', [Session::get('dental_encounter_id'),'opd']??0 ): '' }}" target="_blank">Examination</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('dental_encounter_id')?route('dataview.radiology', ['encounter_id' => Session::get('dental_encounter_id')??0,'opd'] ): '' }}" target="_blank">Radiology</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                <li>
                                    <a class="iq-sub-card" href="{{ route('dental.opdsheet.generate', $enpatient->fldencounterval??0) }}?opd" target="_blank">OPD Sheet</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ route('outpatient.history.generate', $patient->fldpatientval??0) }}?opd" target="_blank">Complete</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="outcomeMenu.followupModal()">Follow Up</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="outcomeMenu.refertoModal()">Refer To</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="finish.displayModal()">Finish</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="historyNav.encounterModal()">Encounter(local)</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('dental_encounter_id')?route('patient.menu.history.pdf.laboratory', Session::get('dental_encounter_id')??0 ): '' }}?opd" target="_blank">Laboratory(local)</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('dental_encounter_id')?route('patient.menu.history.pdf.radiology', Session::get('dental_encounter_id')??0 ): '' }}?opd" target="_blank">Radiology(local)</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('dental_encounter_id')?route('patient.menu.history.pdf.medicine', Session::get('dental_encounter_id')??0 ): '' }}?opd" target="_blank">Medicine(local)</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="javascript:void(0)" onclick="historyNav.selectionModal()">Selection(local)</a>
                                </li>
                            </ul>
                        </div>
                    </li>
