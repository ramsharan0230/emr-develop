                ...
                <ul class="navbar-nav navbar-list">
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                <li><a class="iq-sub-card" href="{{ route('ent.reset.encounter') }}">Blank form</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                ...
                                $encID = \Session::get('ent_encounter_id');
                                ...
                                <li class="inner-submenu">
                                    ...
                                    <div class="iq-inner-sub-dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ Session::has('ent_encounter_id')?route('patient.dataview.pdf.complete', [Session::get('ent_encounter_id'),'opd']??0 ): '' }}" target="_blank" class="iq-sub-card">Complete</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('ent_encounter_id')?route('patient.dataview.pdf.examination', [Session::get('ent_encounter_id'),'opd']??0 ): '' }}" target="_blank">Examination</a>
                                </li>
                                <li>
                                    <a class="iq-sub-card" href="{{ Session::has('ent_encounter_id')?route('dataview.radiology', ['ent_encounter_id' => Session::get('ent_encounter_id')??0,'opd'] ): '' }}" target="_blank">Radiology</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="iq-sub-dropdown navbar-scroll">
                            <ul>
                                ...
                                <li><a class="iq-sub-card" href="{{ Session::has('ent_encounter_id')?route('patient.menu.history.pdf.laboratory', Session::get('ent_encounter_id')??0 ): '' }}?opd" target="_blank">Laboratory(local)</a></li>
                                <li><a class="iq-sub-card" href="{{ Session::has('ent_encounter_id')?route('patient.menu.history.pdf.radiology', Session::get('ent_encounter_id')??0 ): '' }}?opd" target="_blank">Radiology(local)</a></li>
                                <li><a class="iq-sub-card" href="{{ Session::has('ent_encounter_id')?route('patient.menu.history.pdf.medicine', Session::get('ent_encounter_id')??0 ): '' }}?opd" target="_blank">Medicine(local)</a></li>
