...
<main>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="width: 200px;"><p><strong>REPORT:</strong> Other Items</p></td>
        </tr>
        </tbody>
    </table>
        ...
        @if(count($tblpatbilling))
            ...
            @foreach($tblpatbilling as $billing)
                <tr>
                    ...
                    <td>{{ $billing->fldditemamt }}</td>
                    <td>{{ $billing->fldbillno }}</td>
                </tr>
                @php $total_amount += $billing->fldditemamt; @endphp
            @endforeach
        @else
            <tr>
