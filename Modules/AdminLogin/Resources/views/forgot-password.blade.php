    ...
    <div class="container ">
        ...
        <div class="sign-in-page">
            ...
            <!-- @if( Options::get('brand_image') && Options::get('brand_image') != "" )
                ...
                <h3 class="mb-0 text-primary">Forgot Password</h3>
                <p>Welcome To {{Options::get('siteconfig')['system_name']??''}}</p>


                <form action="{{ route('password.request.submit') }}" id="login-form" method="POST" class="mt-4">
                    {{ csrf_field() }}

                    <div class="form-group">
                        <label for="email">Enter Email</label>
                        <input type="text" class="form-control mb-0" id="email" placeholder="Enter email" name="email"/>
                    </div>
