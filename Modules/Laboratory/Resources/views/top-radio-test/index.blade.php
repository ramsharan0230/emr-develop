                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <a href="{{route('laboratory.top.ten.radio.test')}}" type="button" class="btn btn-light btn-action" ><i class="fa fa-redo"></i>&nbsp;Reset</a>
                                </div>
                            </div>                                                                        
                        </div>
                    </form>
            ...
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                <div class="iq-card-body">
                    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab-two" role="tablist">
                        ...
                        <li>
                            <a href="javascript:void(0);" type="button" btn-action onclick="pdfTopRadioTestReport()" class="btn btn-primary btn-action"><i class="fas fa-file-pdf"></i>&nbsp;pdf</a>
                            <a href="javascript:void(0);" onclick="exportTopRadioTestReport()" type="button" class="btn btn-primary btn-action"><i class="fa fa-code"></i>&nbsp;Export</a>
                        </li>
                    </ul>
...
<script>
    ...
    function pdfTopRadioTestReport() {
        var data = $("#top_radio_test").serialize();
        var urlReport = baseUrl + "/admin/laboratory/top/ten-radio-test-pdf?" + data + "&action=" + "Report" + "&_token=" + "{{ csrf_token() }}";

        window.open(urlReport, '_blank');
    }
    function exportTopRadioTestReport() {
        var data = $("#top_radio_test").serialize();
        var urlReport = baseUrl + "/admin/laboratory/top/ten-radio-test-export?" + data + "&action=" + "Report" + "&_token=" + "{{ csrf_token() }}";
        window.open(urlReport, '_blank');
    }
