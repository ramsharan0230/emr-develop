...
<!-- footer 4,  2 prepared by 2verified by-->
<footer *ngIf="footer4" class="pdf-container sign-container">
    <div style="width: 22%;float: left;padding:10px 10px 0;">
    ...
    <div style="width: 22%;float: left;padding:10px 10px 0;">
        @if(Options::get('pcr_left_center_signature')=='left_center_signature_auto')
            <div>
        ...
        @endif
        <!--Manual (all handwritten signatrue and details)-->
        @if(Options::get('pcr_left_center_signature')=='left_center_signature_manual')
            <div>
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p >
                    Performed By : <br>
        ...
        @endif
        <!-- Upload(both signature uplaod and details upload)-->
        @if(Options::get('pcr_left_center_signature')=='left_center_signature_upload')
            <div >
                @if (Options::get('pcr_left_center_signature_image'))
                    <img src="{{ asset('uploads/config/'.Options::get('pcr_left_center_signature_image')) }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;" />
                @endif
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p>Performed By :</p>
                <div class="doctor-details">
                    {!!Options::get('pcr_left_center_signature_textarea')!!}
                </div>
    ...
    <div style="width: 22%;float: right;padding:10px 10px 0;">
        @if(Options::get('pcr_right_center_signature')=='right_center_signature_auto')
            <div>
        ...
        @endif
        <!--Manual (all handwritten signatrue and details)-->
        @if(Options::get('pcr_right_center_signature')=='right_center_signature_manual')
            <div>
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p >
                    Verified By : <br>
        ...
        @endif
        <!-- Upload(both signature uplaod and details upload)-->
        @if(Options::get('pcr_right_center_signature')=='right_center_signature_upload')
            <div >
                @if (Options::get('pcr_right_center_signature_image'))
                <img src="{{ asset('uploads/config/'.Options::get('pcr_right_center_signature_image')) }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;" />
                @endif
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p>Verified By :</p>
                <div class="doctor-details">
                    {!!Options::get('pcr_right_center_signature_textarea')!!}
                </div>
    ...
    <div style="width: 22%;float: right;padding:10px 10px 0;">
        @if(Options::get('pcr_right_signature')=='right_signature_auto')
            <div>
                @if (isset($user_verified_second->signature_image))
                    <img class="signature-image" src="data:image/jpg;base64,{{ $user_verified_second->signature_image??'' }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;">
                @endif
                <p class="underline" style="margin-top: 5px;margin-bottom: 0;">_________________________</p>
                <p>Verified By :<br>
                    <span class="uppercase">{{$user_verified_second->fldcategory??''}} {{$user_verified_second->firstname??''}} {{$user_verified_second->middlename??''}} {{$user_verified_second->lastname??''}}</span><br>
                    {{ $user_verified_second->signature_title??''}}<br>
                    @if(isset($user_verified_second->nhbc))
                    NHPC : {{$user_verified_second->nhbc??''}}
                    @endif
                </p>
            </div>
        @endif
