...
<footer  class="pdf-container sign-container">
    ...
    <div style="width:28%;float: left;padding:10px 10px 0;">
        @if(Options::get('pcr_center_signature')=='center_signature_auto')
            <div>
        ...
        @endif
        <!--Manual (all handwritten signatrue and details)-->
        @if(Options::get('pcr_center_signature')=='center_signature_manual')
            <div>
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p >
                    Verified By : <br>
        ...
        @endif
        <!-- Upload(both signature uplaod and details upload)-->
        @if(Options::get('pcr_center_signature')=='center_signature_upload')
         <div>
             @if(Options::get('pcr_center_signature_image'))
                <img src="{{ asset('uploads/config/'.Options::get('pcr_center_signature_image')) }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;" />
             @endif
            <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
            <p>Verified By :</p>
            <div class="doctor-details">
                {!!Options::get('pcr_center_signature_textarea')!!}
            </div>
