...
<footer *ngIf="footer4" class="pdf-container sign-container">
    ...
    <div style="width: 22%;float: left;padding:10px 10px 0;">
        @if(Options::get('left_center_signature')=='left_center_signature_auto')
            <div>
        ...
        @endif
        <!--Manual (all handwritten signatrue and details)-->
        @if(Options::get('left_center_signature')=='left_center_signature_manual')
            <div>
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p >
                    Performed By : <br>
        ...
        @endif
        <!-- Upload(both signature uplaod and details upload)-->
        @if(Options::get('left_center_signature')=='left_center_signature_upload')
            <div >
                @if (Options::get('left_center_signature_image'))
                    <img src="{{ asset('uploads/config/'.Options::get('left_center_signature_image')) }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;" />
                @endif
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p>Performed By :</p>
                <div class="doctor-details">
                    {!!Options::get('left_center_signature_textarea')!!}
                </div>
    ...
    <div style="width: 22%;float: right;padding:10px 10px 0;">
        @if(Options::get('right_center_signature')=='right_center_signature_auto')
            <div>
        ...
        @endif
        <!--Manual (all handwritten signatrue and details)-->
        @if(Options::get('right_center_signature')=='right_center_signature_manual')
            <div>
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p >
                    Verified By : <br>
        ...
        @endif
        <!-- Upload(both signature uplaod and details upload)-->
        @if(Options::get('right_center_signature')=='right_center_signature_upload')
            <div >
                @if (Options::get('right_center_signature_image'))
                <img src="{{ asset('uploads/config/'.Options::get('right_center_signature_image')) }}" alt="signature" width="100" height="50" style="margin-bottom:-10px;" />
                @endif
                <p class="underline" style="margin-top: 35px;margin-bottom: 0;">_________________________</p>
                <p>Verified By :</p>
                <div class="doctor-details">
                    {!!Options::get('right_center_signature_textarea')!!}
                </div>
