...
<body>
    {{-- header --}}
    @if(Options::get('lab_patient_header')=='header1')
        @include('laboratory::pdf.header.lab-header-1')
    @endif
    @if(Options::get('lab_patient_header')=='header2')
        @include('laboratory::pdf.header.lab-header-2')
    @endif
    @if(Options::get('lab_patient_header')=='header3')
        @include('laboratory::pdf.header.lab-header-3')
    @endif

    {{-- section --}}
    @include('laboratory::pdf.section.lab-one-page-section')
    {{-- @include('laboratory::pdf.section.lab-pcr-patient') --}}
    {{--footer  --}}
    @if(Options::get('lab_patient_footer')=='footer1')
        @include('laboratory::pdf.footer.lab-footer-1')
    @endif
    @if(Options::get('lab_patient_footer')=='footer2')
        @include('laboratory::pdf.footer.lab-footer-2')
    @endif
    @if(Options::get('lab_patient_footer')=='footer3')
        @include('laboratory::pdf.footer.lab-footer-3')
    @endif
    @if(Options::get('lab_patient_footer')=='footer4')
