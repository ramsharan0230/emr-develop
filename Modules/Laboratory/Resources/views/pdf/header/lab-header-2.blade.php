...
<header class="pdf-container hospital-header-container">
 <table style="width: 100%;">
     <tbody>
         <tr>
             <td style="width: 20%;"><img src="{{ asset('uploads/config/'.Options::get('brand_image')) }}" alt="" width="100"
                     height="100" /></td>
             <td style="width:60%;">
             ...
             <td style="width: 20%;text-align: right;"><img src="{{ asset('uploads/config/'.Options::get('brand_image')) }}" alt=""
