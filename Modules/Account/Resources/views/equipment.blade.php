        ...
        <div class="col-sm-12">
            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                <div class="iq-card-body">
                    <form id="js-equipment-add-form">
                        <div class="form-row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group form-row align-items-center">
                                    <label class="col-lg-3 col-sm-4">Item Code</label>
                                    <div class="col-lg-9 col-sm-6">
                                        <select class="form-control select2" name="fldbillitem" id="js-equipment-billitem-input" data-variable="tblbillitem">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group form-row align-items-center">
                                    ...
                                    <div class="col-lg-9 col-sm-8">
                                        <select class="form-control" name="fldgroup" id="js-equipment-bill-mode-select" required>
                                            <option value="">-- Select --</option>
                                            <option value="%">%</option>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group form-row align-items-center">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="fldstatus" class="form-control" id="js-equipment-status-input" required>
                                            <option value="">-- Select --</option>
                                    ...
                                    <div class="col-sm-2">
                                        <button type="button" class="btn btn-primary" id="js-equipment-search-btn">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group form-row align-items-center">
                                    ...
                                    <div class="col-lg-9 col-sm-6">
                                        <select name="fldreport" id="js-equipment-section-input" class="form-control select2" data-variable="tblbillsection">
                                            <option value="">-- Select --</option>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group form-row align-items-center">
                                    ...
                                    <div class="col-lg-9 col-sm-8">
                                        <input type="text" class="form-control" name="flditemname" id="js-equipment-item-name-input" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-lg-6">
                ...
                <div class="form-group text-right">
                    <button type="button" id="js-equipment-save-btn" class="btn btn-primary"><i class="fas fa-plus"></i> Add</button>
                    <button type="button" id="js-equipment-update-btn" class="btn btn-info"><i class="fa fa-edit"></i> Update</button>
                    <button type="button" id="js-equipment-clear-btn" class="btn btn-warning"> Clear</button>
                    <a href="{{ route('account.equipment.exportItems') }}" target="_blank" id="js-equipment-export-btn" class="btn btn-warning"><i class="fa fa-file-pdf" aria-hidden="true"></i></a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="iq-card-body">
            <div class="res-table table-sticky-th">
                <div class="form-group form-row align-items-center">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="search" id="js-equipment-search-input">
                    </div>
                    <div class="col-sm-2">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tbody id="js-equipment-item-tbody">
...
<div class="modal fade" id="js-equipment-add-item-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <input type="text" id="js-equipment-flditem-input-modal" style="width: 100%;">
                    <input type="hidden" id="js-equipment-type-input-modal">
                    <input type="hidden" id="js-equipment-category-input-modal" value="Equipment">
                </div>
                <div>
                    <button class="btn btn-default" id="js-equipment-add-btn-modal"><i class="fa fa-plus"></i> &nbsp;Add</button>
                    <button class="btn btn-default" style="float: right;" id="js-equipment-delete-btn-modal"><i class="fa fa-trash"></i> &nbsp;Delete</button>
                </div>
                <br>
                <div class="table-responsive table-sroll-lab">
                    <table id="js-equipment-table-modal" class="table table-bordered table-hover"></table>
                </div>
                <div class="row">
                    <div class="col-md-10">
                        <input type="file" id="js-equipment-modal-file-iput" class="form-control" accept=".txt">
                    </div>
                    <div class="col-md-2">
                        <button class="btn btn-primary" id="js-equipment-modal-import-btn">Import</button>
                    </div>
                </div>
            </div>
...
@push('after-script')
<script src="{{ asset('js/equipment_form.js')}}"></script>
<script>
    $(function() {
        $("#js-equipment-update-btn").attr('disabled', true);
        ...
        $("#seach_indb").click(function () {
            var status = $('#js-equipment-status-input').val();
            var query = $('#js-equipment-search-input').val();

            $.ajax({
                url: '{{ route('account.equipment.search') }}',
                type: "POST",
                data:{
                    status :status,
                    input : query,
                ...
                success: function (response) {
                    if(response.item){
                        $('#js-equipment-item-tbody').empty().append(response.item);
                    }else {
                        $('#js-equipment-item-tbody').empty().append('<tr><td colspan="8"> Nothing found! </td></tr>');
                    }
                },
