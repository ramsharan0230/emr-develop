...
class ProcedureController extends Controller
{
    ...
    private $_itemcategory = 'Procedures';
    public function index(Request $request)
    {
         ...
         */
        (!Permission::checkCanAccessSpecificMethodFromUrl(auth('admin_frontend')->user()->id, [ 'procedures', 'procedures-view'  ])  ) ?
            abort(403, config('unauthorize-message.item-master.procedures.view')) : true ;
        ...
        return view('account::procedure', compact('billingset','billitems', 'sections', 'all_items', 'categories','accountLedger'));
    }
    ...
    public function saveUpdate(Request $request)
    {
         ...
         * @retunr 403 status and boolean mixed
         */
        (!Permission::checkCanAccessSpecificMethodFromUrl(auth('admin_frontend')->user()->id, [ 'procedures', 'procedures-add','procedures-update'  ])  ) ?
            abort(403, config('unauthorize-message.item-master.procedures.update')) : true ;
    ...
    public function exportItems()
    {
        ...
        return \Barryvdh\DomPDF\Facade::loadView('account::procedurePdf', compact('all_items'))
            ->stream('procedurePdf.pdf');
    }
