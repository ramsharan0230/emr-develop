...
class EquipmentController extends Controller
{
    ...
    private $_itemcategory = 'Equipment';
    public function index(Request $request)
    {
         ...
         */
        (!Permission::checkCanAccessSpecificMethodFromUrl(auth('admin_frontend')->user()->id, [ 'equipments', 'equipments-view'  ])  ) ?
            abort(403, config('unauthorize-message.item-master.equipments.view')) : true ;
        ...
        return view('account::equipment', compact('billingset', 'billitems', 'sections', 'all_items', 'categories','accountLedger'));
    }
    ...
    public function saveUpdate(Request $request)
    {
         ...
         * @retunr 403 status and boolean mixed
         */
        (!Permission::checkCanAccessSpecificMethodFromUrl(auth('admin_frontend')->user()->id, [ 'equipments', 'equipments-add', 'equipments-update'  ])  ) ?
            abort(403, config('unauthorize-message.item-master.equipments.view')) : true ;
    ...
    public function exportItems()
    {
        ...
        return \Barryvdh\DomPDF\Facade::loadView('account::equipmentPdf', compact('all_items'))
            ->stream('equipmentPdf.pdf');
    }
