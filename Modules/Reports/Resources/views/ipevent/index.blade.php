                                ...
                                <div class="parent-row row">
                                    <div class="col-md-3">
                                        <div class="form-group date-input">
                                            ...
                                            <input type="text" class="form-input" placeholder="YYYY-MM-DD" name="date_from" value="{{ $date_from }}">
                                        </div>
                                        <div class="form-group date-input">
                                            <label for="" class="form-label">To:</label>
                                            <input type="text" class="form-input" placeholder="YYYY-MM-DD" name="date_to" value="{{ $date_to }}">
                                        </div>                                        
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group-inner custom-4">
                                                ...
                                                <select name="gender" id="gender" class="form-input">
                                                    <option value="" @if(request()->get('gender') == 'all') selected=selected @endif>%</option>
                                                    <option value="Male" @if(request()->get('gender') == 'Male') selected=selected @endif>Male</option>
                                                    <option value="Female" @if(request()->get('gender') == 'Female') selected=selected @endif>Female</option>
                                                    <option value="Other" @if(request()->get('gender') == 'Other') selected=selected @endif>Other</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group-inner custom-4">
                                            <label for="" class="form-label">Age(Yr)</label>
                                            <input type="text" name="age_from" class="form-input" id="age_from" value="{{ request()->get('age_from') ?: '0' }}">
                                            <input type="text" name="age_to" class="form-input" id="age_to" value="{{ request()->get('age_to') ?: '0' }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
