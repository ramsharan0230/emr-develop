...
@section('content')
                ...
                <div class="col-md-8">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="strengthandlabeling" role="tabpanel" aria-labelledby="home-tab" style="border:1px solid #a7a5a3;">
                            <div class="container-fluid">
                                <form action="{{ route('medicines.medicineinfo.addlabel', encrypt($drug->flddrug)) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-5 padding-none">
                                                    <div class="form-inner">
                                                        ...
                                                        <input type="text"  name="fldsubroute" value="{{ old('fldsubroute') }}" placeholder="" size="6" required>
    ...
    {{--                                                    </select>--}}
                                                    ...
                                                    <div class="form-inner">
                                                        ...
                                                        <input type="number" step="any" min="0" name="fldosmolality" value="{{ old('fldosmolality') }}" placeholder="0" style="width: 6em;">
                                                    </div>
                                                    <div class="form-inner">
                                                        <label for="" class="form-label" style="width: 12em">Final Strength(mg/mL)</label>
                                                        <input type="number" step="any" min="0" name="fldfinalstr" value="{{ old('fldfinalstr') }}" placeholder="0" style="width: 6em;">
                                                    </div>
                                                    <div class="form-inner">
                                                        <label for="" class="form-label" style="width: 12em">Energy(KCal/mg)</label>
                                                        <input type="number" step="any" min="0" name="fldenergy" value="{{ old('fldenergy') }}" placeholder="0" style="width: 6em;">
                                                    </div>
                                                    <div class="form-inner">
                                                    ...
                                                    <div class="form-inner">
                                                        ...
                                                        <div class="tab-content" id="nav-tabContent">
                                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                                                <textarea name="fldopinfo" id=oplabel" cols="52" rows="4">{!! old('fldopinfo') !!}</textarea>
                                                            </div>
                                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                                <textarea name="fldipinfo" id="iplabel" cols="52" rows="4"{!! old('fldipinfo') !!}></textarea>
                                                            </div>
                                                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                                                <textarea name="fldasepinfo" id="udlabel" cols="52" rows="4">{!! old('fldasepinfo') !!}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <textarea name="fldmedinfo" style="min-height: 200px;" cols="91">{!! old('fldmedinfo') !!}</textarea>
                                            </div>
