            ...
            <div class="col-md-8">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="brandinformation" role="tabpanel" aria-labelledby="profile-tab" style="border:1px solid #a7a5a3;">
                        <div class="container-fluid">
                            <form action="{{ route('medicines.medicineinfo.addbrandinfo', encrypt($drug->flddrug)) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-7 padding-none">
                                            <div class="form-inner">
                                                ...
                                                <input type="text" name="fldbrand" value="{{ old('fldbrand') }}" placeholder="" size="20" required>
                                            </div>
                                            <div class="form-inner">
                                                <label for="" class="form-label">Pack Volume</label>
                                                <input type="number" step="any" min="0" name="fldpackvol" value="{{ old('fldpackvol') }}" placeholder="0" style="width: 3em;">
                                                <input type="text" name="fldvolunit" value="{{ old('fldvolunit') }}" placeholder="" size="14">
                                            </div>
                                            <div class="form-inner">
                                            ...
                                            <div class="form-inner">
                                                ...
                                                <input type="text" name="fldstandard" value="{{ old('fldstandard') }}" placeholder="" size="20">
                                            </div>
                                            <div class="form-inner">
                                                <label for="" class="form-label">Manufacturer</label>
                                                <input type="text" name="fldmanufacturer" value="{{ old('fldmanufacturer') }}" placeholder="" size="20">
                                            ...
                                            <div class="form-inner">
                                                ...
                                                <input type="text" name="fldpreservative" value="{{ old('fldpreservative') }}" placeholder="" size="20">
                                            </div>
                                            <div class="form-inner">
                                                <label for="" class="form-label">Description</label>
                                                <textarea name="flddetail" style="min-height: 200px;" cols="50">{!! old('flddetail') !!}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-5 padding-none">
                                            ...
                                            <div class="form-inner">
                                                ...
                                                <input type="number" step="any" name="fldminqty" value="{{ old('fldminqty') }}" placeholder="0" min="0" style="width: 8em;">
                                            </div>
                                            <div class="form-inner">
                                                <label for="" class="form-label" style="width: 149px;">Maximum Stock</label>
                                                <input type="number" step="any" name="fldmaxqty" value="{{ old('fldmaxqty') }}" placeholder="0" min="0" style="width: 8em;">
                                            </div>
                                            <div class="form-inner">
                                                <label for="" class="form-label" style="width: 149px;">Lead Time (Days)</label>
                                                <input type="number" step="any" name="fldleadtime" value="{{ old('fldleadtime') }}" placeholder="0" min="0" style="width: 8em;">
                                            </div>
                                            <div class="form-inner">
                                ...
                                <div class="row">
                                    <div class="col-md-4 padding-none">
                                        <button type="submit"><img src="{{asset('assets/images/plus.png')}}" width="16px">&nbsp;&nbsp;Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
