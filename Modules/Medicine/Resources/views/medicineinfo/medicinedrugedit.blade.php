    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #efebe7;">
                <li class="nav-item" >
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#strengthandlabeling" role="tab" aria-controls="home" aria-selected="true">Strength</a>
                </li>
                {{--                        <li class="nav-item" >--}}
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="strengthandlabeling" role="tabpanel" aria-labelledby="home-tab" style="border:1px solid #a7a5a3;">
                    <div class="container-fluid">
                        <form action="{{ route('medicines.medicineinfo.updatedrug', encrypt($drug->flddrug)) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="form-inner">
                                        ...
                                        <select name="fldcodename" class="form-select-dietary select2genericname" required>
                                            ...
                                            <option value="{{ $code->fldcodename }}" data-id="{{ $code->fldcodename }}" {{ (old('fldcodename') && old('fldcodename') == $code->fldcodename || $drug->fldcodename == $code->fldcodename) ? 'selected' : ''}}>{{ $code->fldcodename }}</option>
                                            @empty
                                            @endforelse
                                        </select>&nbsp;
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#code_modal"><img src="{{asset('assets/images/add.png')}}" style="width: 23px;"></a>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            ...
                                            <select name="fldroute" >
                                                <option value=""></option>
                                                <option value="anal/vaginal" {{  (old('fldroute') == 'anal/vaginal' || $drug->fldroute == 'anal/vaginal') ? 'selected' : '' }}>anal/vaginal</option>
                                                <option value="eye/ear" {{  (old('fldroute') == 'eye/ear' || $drug->fldroute == '')? 'selected' : 'eye/ear' }}>eye/ear</option>
                                                <option value="fluid" {{  (old('fldroute') == 'fluid' || $drug->fldroute == 'fluid')? 'selected' : '' }}>fluid</option>
                                                <option value="injection" {{  (old('fldroute') == 'injection' || $drug->fldroute == 'injection')? 'selected' : '' }}>injection</option>
                                                <option value="liquid" {{  (old('fldroute') == 'liquid' || $drug->fldroute == 'liquid')? 'selected' : '' }}>liquid</option>
                                                <option value="oral" {{  (old('fldroute') == 'oral' || $drug->fldroute == 'oral')? 'selected' : '' }}>oral</option>
                                                <option value="resp" {{  (old('fldroute') == 'resp' || $drug->fldroute == 'resp')? 'selected' : '' }}>resp</option>
                                                <option value="topical" {{  (old('fldroute') == 'topical' || $drug->fldroute == 'topical')? 'selected' : '' }}>topical</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            ...
                                            <input type="number" step="any" min="0" name="fldstrength" value="{{ $drug->fldstrength }}" placeholder="0" style="width: 3em;" required>
                                            <input type="text" name="fldstrunit" value="{{ $drug->fldstrunit }}" placeholder="" size="14" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            ...
                                            <input type="number" step="any" min="0" name="fldciyear" value="{{ $drug->fldciyear }}" placeholder="0" style="width: 5em;">
                                        </div>
                                    </div>
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            <label for="" class="form-label" style="width: 79px;">Reference</label>
                                            <input type="text" name="fldreference" value="{{ $drug->fldreference }}" placeholder="" size="20">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            ...
                                            <a href="javascript:void(0)" data-toggle="modal" data-target=""><img src="{{asset('assets/images/add.png')}}" style="width: 23px;"></a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 padding-none">
                                        <div class="form-inner">
                                            <label for="" class="form-label" style="width: 79px;"> <i class="fa fa-search"></i> Help</label>
                                            <input type="text" name="fldhelppage"  value="{{ $drug->fldhelppage }}" placeholder="" size="20">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 padding-none">
                                    <button type="submit"><img src="{{asset('assets/images/edit.png')}}" width="20px">&nbsp;&nbsp;Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
