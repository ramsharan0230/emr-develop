<div class="modal fade" id="finalobstetricdiagnosis">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="form-data-obstetric">
                ...
                <form id="final-obstetric-request-submit">
                    @csrf
                    {{--@php--}}
                        {{--$encounterData = $enpatient;--}}
                        {{--$encounterDataPatientInfo = $enpatient->patientInfo;--}}
                    {{--@endphp--}}
                    <input type="hidden" name="encounter" value="@if(isset($enpatient) and $enpatient !=''){{ $enpatient->fldencounterval }}@endif">
                    <input type="hidden" name="fldinput" value="Obstetric">
                    <input type="hidden" name="patfinding" value="@if(isset($patfinding) && $patfinding !=''){{$patfinding->fldid}}@else 0 @endif">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control changepp" name="gravida" id="gravida" value="@if(isset($gravida) and $gravida !=''){{$gravida->fldreportquanti}}@endif" onchange="updateInput(value)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control changepp" name="parity" id="parity" value="@if(isset($parity) and $parity !=''){{$parity->fldreportquanti}}@endif" onchange="updateInput(value)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" class="form-control changepp" name="abortion" id="abortion" value="@if(isset($abortion) and $abortion !=''){{$abortion->fldreportquanti}}@endif" onchange="updateInput(value)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control changepp" name="living" id="living" value="@if(isset($living) and $living !=''){{$living->fldreportquanti}}@endif" onchange="updateInput(value)">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control changepp datepicker" name="lmp_ad" id="lmp_ad" value="@if(isset($lmp) and $lmp !=''){{$lmp->fldreportquali}}@endif" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    <input type="text" class="form-control changepp nepalidate" name="lmp_bs" id="lmp_bs" value="" autocomplete="off" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control changepp " name="edd_ad" id="edd_ad" value="@if(isset($edd) and $edd !=''){{$edd->fldreportquali}}@endif" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    <input type="text" class="form-control changepp nepalidate" name="edd_bs" id="edd_bs" value="" autocomplete="off" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" class="form-control changepp" name="gestationweek" id="gestationweek" value="@if(isset($gestationweek) and $gestationweek !=''){{$gestationweek}}@endif" onchange="updateInput(value)">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-row">
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control changepp" name="gestationdays" id="gestationdays" value="@if(isset($gestationdays) and $gestationdays !=''){{$gestationdays}}@endif" onchange="updateInput(value)">
                                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-primary update_btn" id="js-obstetric-diagnosis-update-btn" onclick="updateFinalObstetric()">Update</button>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function updateFinalObstetric(){
        // alert('here');
        // data :   $("form").serialize();
        // console.log(data);
        var url = "{{ route('physiotherapy.diagnosis.final.obstetric.form.save.waiting') }}";

        $.ajax({
            url: url,
            type: "POST",
            data:  $("#final-obstetric-request-submit").serialize(),"_token": "{{ csrf_token() }}",
            success: function(response) {
                // response.log()
                ...
                if ($.isEmptyObject(response.error)) {
                    ...
                    $('#finalobstetricdiagnosis').modal('hide');
