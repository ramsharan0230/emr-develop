<div class="modal fade" id="finalicddiagnosis">
            ...
            <form method="post" id="final-diagnosis">
               @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="updateFinalDiagnosis()">
                        Submit
                    </button>
...
<script type="text/javascript">
    function updateFinalDiagnosis(){
        // alert('diagn')
        var url = '{{route("physiotherapy.diagnosis.finalDiagnosisStore")}}';
