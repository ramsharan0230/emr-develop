...
class TherapeuticExcercisesController extends Controller
{
    public function insertTherapeuticExcercises(Request $request) {
        try {
            $data = array(
                'fldencounterval' => $request->fldencounterval,
                'fldinput'        => 'Therapeutic Excercices',
                'fldtype'         => 'Qualitative',
            ...
            if ($latest_id) {
                ...
                Session::flash('success_message', 'Therapeutic Excercises update Successfully.');
