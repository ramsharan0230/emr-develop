...
(function (jQuery) {
    ...
    jQuery(".color-choose li").on("click", function (e) {
        jQuery(".color-choose li").removeClass("active");
        jQuery(this).addClass("active");
    });

    jQuery(".inner-submenu").first("a").hover(function (e) {
        e.preventDefault()
        jQuery(".iq-inner-sub-dropdown").toggleClass("menu-show");
    });

    var scrollBtn = jQuery('#scroll-btn');
    ...
    //     var anchor_top = jQuery("#mainStockTable").offset().top;
    //     var anchor_bottom = jQuery("#bottom_anchor").offset().top;
    //     if (scroll>anchor_top && scroll<anchor_bottom) {
    //     clone_table = jQuery("#clone");
    //     if(clone_table.length == 0){
    //         clone_table = jQuery("#mainStockTable").clone();
    //         clone_table.attr('id', 'clone');
    //         clone_table.css({position:'fixed',
    //                  'pointer-events': 'none',
    //                  top:'79px'});
    //         clone_table.width(jQuery("#mainStockTable").width());
    //         jQuery("#stockTable").append(clone_table);
