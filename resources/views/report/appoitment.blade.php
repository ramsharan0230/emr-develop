                        ...
                        <table class="table table-striped table-hover table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="#" class="badge border border-success text-success">Checked in</a></td>
                                ...
                                <tr>
                                    <td class="text-center">1</td>
                                    <td class="text-center"><a href="#" class="badge border border-danger text-danger">Booked</a></td>
                                    <td class="text-center">123</td>
                                    <td>March 23,2021 <i class="ri-time-line"></i>&nbsp;<em>11:30 AM</em></td>
                                    <td>
                                        Archana Rai, 23y/F<br />
